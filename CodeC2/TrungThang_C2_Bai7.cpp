...
//{
//	if (rear - front == Max - 1) //hàng ??i ??y
//		return 0;
//	else
//	{
//		if (front == -1) //hàng ??i r?ng 
//			front = 0;
//		if (rear == Max - 1) //hàng ??i tràn
//		{
//			for (int i = front; i <= rear; i++)
//				a[i - front] = a[i];
//			rear = Max - 1 - front;
...
//{
//	if (rear - front == Max - 1 || rear - front == -1) //hàng ??i ??y
//		return 0;
//	else
//	{
//		if (front == -1) //hàng ??i r?ng
//			front = 0;
//		if (rear == Max - 1) //hàng ??i ??y
//			rear = -1;
//		a[++rear] = x; //thêm ph?n t? m?i t?i rear
//	}
//	return 1;
// }
